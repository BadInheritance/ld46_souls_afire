...
onready var slides_fadein = [
	$Slide1/FadeIn, $Slide2/FadeIn, $Slide3/FadeIn, $Slide4/FadeIn, $Slide5/FadeIn
]
onready var slides_fadeout = [
	$Slide1/FadeOut, $Slide2/FadeOut, $Slide3/FadeOut, $Slide4/FadeOut, $Slide5/FadeOut
]
